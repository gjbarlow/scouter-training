...
co_file = "CharteredOrganizations.csv"
...
elif not os.path.isfile(co_file):
	print('Chartered organizations file is missing', co_file)
else:
	t = scouter_training.Training(training_file, syt_file, co_file)
	t.summary()
	t.direct_contact()
	t.ranking()